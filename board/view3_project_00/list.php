...
$sql = "select * from ".TABLE_LEFT."project_01 where view3_use = 1";
$res = mysql_query($sql);
$num = mysql_num_rows($res);
$cnt = 1;
foreach ($arr as $data) {
    $res = mysql_query($sql." and view3_sca = ".$data);
    ${'num_'.$cnt} = mysql_num_rows($res);
    $cnt++;
}
...
<ul class="pj_tabmenu fs_def t_center">
    <li <?if ($view3_sca == "0") {echo 'class="on"';}?>><a href="#none" data-sca="0">All Projects <span class="num"><?=$num?></span></a></li>
    <li <?if ($view3_sca == "1") {echo 'class="on"';}?>><a href="#none" data-sca="1">Education Place <span class="num"><?=$num_1?></span></a></li>
    <li <?if ($view3_sca == "2") {echo 'class="on"';}?>><a href="#none" data-sca="2">Commercial Place <span class="num"><?=$num_2?></span></a></li>
    <li <?if ($view3_sca == "3") {echo 'class="on"';}?>><a href="#none" data-sca="3">Other <span class="num"><?=$num_3?></span></a></li>
</ul>
...
?>
    ...
    <style>
        .progress{position:fixed;bottom:0;left:0;width:100%;height:150%;background-color:rgba(161,161,161,0.5);}
        .progress img{position:absolute;top:70%;left:50%;transform:translate(-50%,-70%)}
