...
<div id="boardWrap">
	<div class="sub_titles rline">
		<h3 class="engtxt">Customer Center</h3>
		<h4 class="imgtxt"><img src="<?=$root?>/img/board/cust_page_title.png" alt="고객센터"></h4>
	</div>
...
?>
						<tr>
							<th scope="row"><label for="iqr_email_01"<?if($view3_sca != '1n1_01' && $view3_sca != 'jungbo_01'){echo ' class="required"';}?>>이메일</label></th>
							<td>
								<?=$view_email?>
							</td>
						</tr>
