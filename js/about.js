...
new Tabbing($('.lyr2_tab'), $('.lyr2_conts'));

$(".hist_cont").mCustomScrollbar({
    axis:"x",
    theme:"dark"
});
...
new YMotion([
    [
        {el: '.right_area', set: {y: 100, opacity: 0}, to: {y: 0, opacity: 1}, d: 1},
	],
    [
        {el: '.org_img', set: {y: 100, opacity: 0}, to: {y: 0, opacity: 1}, d: 1},
	],
]).activate();
