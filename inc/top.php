...
if ($_REQUEST['title']) {
	$h2_title_kr = $_REQUEST['title'];
	$h2_title_kr_old = $_REQUEST['title'];
} else {
...
?>
    ...
    <div class="sub_visual">
        <h2 class="sub_title"><?=$group_list['view3_title_01']?></h2>

		<div class="sub_top">
			<ul class="lnb lnb<?=$gnb_index?> fs_def">
<?
...
?>
				<li class="lnb<?=$gnb_index?>_page<?=$depth2_list['view3_order_css']?><?if($gnb_index != 1 && $depth2_list['view3_order_css'] == $minor_index){echo ' on';}?>">
